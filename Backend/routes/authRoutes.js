...
const { registerUser, loginUser, getUsersById, updateuserProfile, updateuserPassword, verifyEmail, forgotPassword, resetPassword } = require("../controllers/authController");
